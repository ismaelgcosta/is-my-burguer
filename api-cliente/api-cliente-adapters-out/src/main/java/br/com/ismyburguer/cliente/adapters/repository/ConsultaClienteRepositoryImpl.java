...
@PersistenceAdapter
public class ConsultaClienteRepositoryImpl implements ConsultaClienteRepository {
    private final ClienteRepository clienteRepository;
    private final ClienteEntityToClienteConverter converter;

    public ConsultaClienteRepositoryImpl(ClienteRepository clienteRepository,
